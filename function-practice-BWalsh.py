...
def total_meal_price(price,tip):
    ...
    #I ran out of time. My brain hurts. I will look back on the problems 
    #I didn't solve over the course of the week. If I tried and program 
    #anymore right now my eyes may start to bleed.
...
def sign_and_parity()
    ...
    # I have run out of time and brain power.
    # Cumulative homework time spent = 8 hours.
